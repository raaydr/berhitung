...
public class Pembagian extends Activity implements OnClickListener{
    ...
    private int [] levelMin = {2,5,10};
    private int [] levelMax = {22,30,50};
        ...
        if (view.getId()== R.id.enterBtn ){
            ...
            if(answerTxt.length()==0){
                ...
                if(count==10) {
                    ...
                    Intent selesai = new Intent(Pembagian.this, HasilKuis.class);
