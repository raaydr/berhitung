...
public class Perkalian extends Activity implements OnClickListener{
    ...
    private int [] levelMin = {2,3,5};
    private int [] levelMax = {10,50,100};
        ...
        if (view.getId()== R.id.enterBtn ){
            ...
            if(answerTxt.length()==0){
                ...
                if(count==10) {
                    ...
                    Intent selesai = new Intent(Perkalian.this, HasilKuis.class);
    ...
    private void choseQuestion(){
        ...
        question.setText(operand1+ "x"+operand2+"=");
    }
